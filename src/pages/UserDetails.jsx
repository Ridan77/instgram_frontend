        ...
        <section className="sub-header">
          <div className="name-section">
            ...
            <button
              ...
              {user.followers?.some((item) => item._id === loggedinUser._id)
                ? "Unfollow"
                : "Follow"}
            </button>
          ...
          <div className="user-counters">
            <span className="bold no1">{stories?.length}</span>
            <span className="gray no2">Posts</span>
            <span className="bold no3">{user.followers?.length}</span>
            <span className="gray no4">Followers</span>
            <span className="bold no5">{user.following?.length}</span>
            <span className="gray no6"> Following</span>
          </div>
        </section>
        {/* <span>{user.bio}</span> */}
      </section>
